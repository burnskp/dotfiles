...
def setup(c, flavour, samecolorrows = False):
    ...
    ## Hints
    c.hints.border = "1px solid " + palette["teal"]
    ...
    c.colors.tabs.bar.bg = palette["surface0"]
    ...
    c.colors.tabs.selected.even.bg = palette["subtext0"]
    # ## Background color of selected odd tabs.
    c.colors.tabs.selected.odd.bg = palette["subtext0"]
