...
function setTwoWindowsFrames()
  ...
  local leftFrame = hs.geometry.rect(0, 0, 1314, screenFrame.h)
  local rightFrame = hs.geometry.rect(1314, 0, screenFrame.w - 1314, screenFrame.h)
